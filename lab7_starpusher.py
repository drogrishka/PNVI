...
def main():
    ...
    currentImage = 4 #Req No. 3: starting character is pinkgirl
    ...
    random.shuffle(levels) #Req No.2
    currentLevelIndex = 0
    ...
    while True: # main game loop
        ...
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT:
                ...
                # Handle key presses
                #Req No. 1: switch camera and player button press movements
                keyPressed = True
                if event.key == K_LEFT:
                    cameraLeft = True
            ...
            # Req No. 1: switch camera buttons
