...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, RESET_SURF, RESET_RECT, NEW_SURF, NEW_RECT, SOLVE_SURF, SOLVE_RECT, HELP_SURF, HELP_RECT,COUNT # REQUIREMENT No.2,3
    ...
    HELP_SURF, HELP_RECT   = makeText('Help', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 120, WINDOWHEIGHT - 120) # REQUIREMENT No.2
...
def drawBoard(board, message):
    ...
    DISPLAYSURF.blit(HELP_SURF, HELP_RECT) #REQUIREMENT No.2
